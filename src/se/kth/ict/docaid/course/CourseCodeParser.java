...
public class CourseCodeParser {
	...
	public static void main(String argv[]) {
		try {
			...
			Document doc = dBuilder.parse("http://www.kth.se/api/kopps/v1/courseRounds/2014:2");
...
//				System.out.println("courseCode: " + course.getCode());
			...
			Document doc1 = dBuilder.parse("http://www.kth.se/api/kopps/v1/courseRounds/2014:1");
			ArrayList<Course> courses1 = retrieveCourseCodes(doc1);
